...
if select_page == "Home":
    ...
    with col1:
        ...
        st.image("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTzYJEPZIjdBtwCyPcnmEUhM1h_y8MnOnGybA&s")
        st.markdown("#")
    ...
    with col2:
        ...
        st.write(":violet[About data :] *Aggregated* - Aggregated values of various payment categories, *Map* - Total values at the State and District levels, *Top* - Totals of top States / Districts /Pin Codes")
        st.write("---")
        ...
        with col3:
            st.download_button("aggInsurance","C:/Users/Admin/Desktop/myproject/agg_ins.csv/")
            st.download_button("aggTransaction","C:/Users/Admin/Desktop/myproject/agg_trans.csv/")
            st.download_button("aggUser","C:/Users/Admin/Desktop/myproject/agg_user.csv/")

        with col4:
            st.download_button("mapInsurance","C:/Users/Admin/Desktop/myproject/map_ins.csv/")
            st.download_button("mapTransaction","C:/Users/Admin/Desktop/myproject/map_trans.csv/")
            st.download_button("mapUser","C:/Users/Admin/Desktop/myproject/map_user.csv/")

        with col5:
            st.download_button("topInsurance","C:/Users/Admin/Desktop/myproject/top_ins.csv/")
            st.download_button("topTransaction","C:/Users/Admin/Desktop/myproject/top_trans.csv/")
            st.download_button("topUser","C:/Users/Admin/Desktop/myproject/top_user.csv/")
